...
system/startup_ldf/%.doj: ../system/startup_ldf/%.s
	...
	easmblkfn.exe -file-attr ProjectName="Mezapp" -proc ADSP-BF537 -si-revision any -g -D_DEBUG -i"D:\Mondragon Unibertsitatea\POPBL 5\Proba\Mezapp\system" -i"C:/Analog Devices/ADSP-BF537_EZKIT-Rel1.0.0/BF537_EZ-KIT_Lite/Blackfin/include" -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
